...
def main():
    ...
    init_parser = subparsers.add_parser(
        "init", help="Initialize a new GitPy repository."
    )

    add_parser = subparsers.add_parser(
        "add", help="Add files and directories to the staging."
    )
    add_parser.add_argument(
        "paths", nargs="+", help="Files and directories to add in GitPy."
    )
    ...
    checkout_parser = subparsers.add_parser(
        "checkout", help="Switch to another branch in GitPy repository."
    )
    ...
    branch_parser = subparsers.add_parser(
        "branch", help="List and manage the branches."
    )
    ...
    branch_parser.add_argument(
        "name", nargs="?", help="Branch name to create or delete."
    )
